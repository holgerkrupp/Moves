...
#ifndef MOVES_SWIFT_H
#define MOVES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Moves",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Moves16MovesAppDelegate")
@interface MovesAppDelegate : NSObject <UIApplicationDelegate, UNUserNotificationCenterDelegate>
- (BOOL)application:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC5Moves27MovesLocationCaptureManager")
@interface MovesLocationCaptureManager : NSObject
...
@class CLVisit;
@class CLLocation;
@interface MovesLocationCaptureManager (SWIFT_EXTENSION(Moves)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC5Moves15WatchRouteInbox")
@interface WatchRouteInbox : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class WCSessionFile;
@class NSString;
@interface WatchRouteInbox (SWIFT_EXTENSION(Moves)) <WCSessionDelegate>
