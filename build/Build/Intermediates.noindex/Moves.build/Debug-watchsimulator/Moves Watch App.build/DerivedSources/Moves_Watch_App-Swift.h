...
#ifndef MOVES_WATCH_APP_SWIFT_H
#define MOVES_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Moves_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Moves_Watch_App20WatchLocationTracker")
@interface WatchLocationTracker : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CLLocationManager;
@class CLLocation;
@interface WatchLocationTracker (SWIFT_EXTENSION(Moves_Watch_App)) <CLLocationManagerDelegate>
...
@class NSString;
@interface WatchLocationTracker (SWIFT_EXTENSION(Moves_Watch_App)) <WCSessionDelegate>
